...
- **Q1: Create a city_state variable (e.g. “Baltimore, MD”), and a
...
- **Q2: For the city of Baltimore, MD, use the glm function to fit a
...
- **Q3: Now run glm for each of the cities in your dataset, and extract
...
- **Q4: Create a plot that shows the estimated ORs and CIs for each
