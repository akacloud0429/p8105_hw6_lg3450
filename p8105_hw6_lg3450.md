...
| Beta Ratio (tmin/prcp) |   -5631.953   |    4889.209    |
...
![](p8105_hw6_lg3450_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->

The distribution of the estimated r-squared values is unimodal and
...
After filtering out the extreme values, the distribution is
approximately normal and centered around 0.94, indicating that the model
consistently explains a high proportion of the variance in maximum
temperature. The distribution of the ratio
$\hat{\beta}_{tmin} / \hat{\beta}_{prcp}$ is left-skewed, with the
majority of estimates falling between -400 and -100. However, the full
distribution is extremely heavy-tailed containing outliers beyond
$\pm 20,000$ (omitted from the plot for clarity), which result from
bootstrap samples with near-zero precipitation coefficients.
...
![](p8105_hw6_lg3450_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
